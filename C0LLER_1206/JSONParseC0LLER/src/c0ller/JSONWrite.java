...
public class JSONWrite {
    public static void main(String[] args) {
        try {
            ...
            Object obj = parser.parse(new FileReader("C:\\Users\\vanda\\Desktop\\C0LLER_1206\\kurzusfelvetelC0LLER.json"));

            JSONObject jsonObject = (JSONObject) obj;

            displayJsonObject("", jsonObject);

            writeJsonToFile(jsonObject, "C:\\Users\\vanda\\Desktop\\C0LLER_1206\\kurzusfelvetelC0LLER1.json");
